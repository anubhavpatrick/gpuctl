...
main() {
    ...
    echo "============================================"
    echo "  IMPORTANT: Review Configuration"
    echo "============================================"
    echo ""
    ...
    echo "  ${CONFIG_FILE}"
    echo ""
    echo "Review and update it for your cluster. Key settings to verify:"
    echo ""
    echo "  NODE_SELECTOR    - Label selector for GPU nodes (default: nvidia.com/gpu.present=true)"
    echo "  MIG_PROFILES     - MIG slice profiles available on your GPUs"
    echo "  REFRESH_INTERVAL - TUI dashboard refresh rate in seconds"
    echo ""
    echo "All settings are documented inline. See also:"
    echo ""
    echo "  ${script_dir}/${SOURCE_CONFIG}  (annotated reference)"
    echo ""
